...
export const Sidebar = () => {
  ...
  const { friendList, profilePicture } = chatData;
    ...
    <aside className="fixed  left-0 bg-white shadow hidden md:block bottom-0 w-[350px] px-3 border-l h-[90vh]">
      <div className="mt-10 flex  overflow-y-scroll">
        ...
        <div className="h-[20vh]">
          ...
          <div className="">
            <Image src={profilePicture?.profile?.profilePicture} className="w-auto h-auto" alt="profile" height={50} width={50} priority/>
          </div>
        </div>
        </div>
